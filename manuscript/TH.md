...
formula-live numbers in each Manuscript_Inputs tab. **TH-b (H2a/H2b RoBMA) pending on F66** — the
DEC-044 language gate resolves only after it.
...
| H2a/H2b · RoBMA | TH-b (pooled + moderation, prior N(0; 0.025) from secondary SESOI) | — pending (F66 JAGS handshake) — | **BLOCKED**; gate input |
...
at the documented gate-resolution step [DEC-044] after the TH-b Bayes factors.
