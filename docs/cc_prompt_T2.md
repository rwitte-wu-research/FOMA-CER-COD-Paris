...
## Task sequence
1. Read `docs/T2_spec.md` in full. It is the complete, frozen specification — models, spec labels, row inventory (93), constants, verifier checks O1–O17, semantics pins P1–P5. Treat every element as binding.
...
- Spec labels, the 93-row inventory, the 36-column schema (T1 schema + `term` after `subset`), ms_input assignments.
