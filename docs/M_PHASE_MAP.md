...
**v1.6 changelog (2026-08-06):**
1. *M-phase close (pre-authorized verbatim, DEC-060 §8):* "M phase closed (DEC-060); #16/bp land as micro-packages with own DECs against the tag `manuscript-v1.0-assembly`, followed by an assembly refresh."
