...
Rev. 2026-07-13b — **F58 erratum:** row-inventory total corrected 93 → 96 (arithmetic error in the header/O3; the §3 table itself was and is correct: 10 coding models × 3 + 31 + 1 + 31 + 3 = 96). Caught by CC STOP S4 with adversarial triple verification before any build.
...
## 3. Analyses, spec labels, and row inventory (96 rows total = 10 coding models × 3 + 31 LOSO + 1 summary + 31 dominance + 3 disclosures)
